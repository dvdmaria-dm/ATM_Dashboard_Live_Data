...
st.markdown(f"<div class='main-header'><div style='display: flex; align-items: center; color: white; font-weight: bold; font-size: 22px; letter-spacing: 1px; white-space: nowrap;'><img src='https://upload.wikimedia.org/wikipedia/commons/9/97/Logo_BRI.png' style='height: 26px; margin-right: 10px; filter: brightness(0) invert(1);' alt='Logo BRI'><span style='margin-left: 15px; font-weight: 400; font-size: 15px; opacity: 0.9;'>WEEKLY ATM PERFORMANCE REVIEW</span></div><div class='info-ticker-container'><div class='info-ticker-text'><span class='status-dot'></span>SYSTEM: SECURE & OPTIMAL &nbsp; | &nbsp; DATA LOADED &nbsp; | &nbsp; SERVER TIME: {current_date_header} &nbsp; | &nbsp; BANK BRI MONITORING ACTIVE &nbsp; | &nbsp; <span style='color: #FBBF24; font-weight: 800; letter-spacing: 1px;'>PT KELOLA JASA ARTHA</span></div></div></div>", unsafe_allow_html=True)
